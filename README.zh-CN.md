...
<p align="center">
  <b>Rust 原生高性能 AI 编程 CLI 工作台。</b><br/>
...
Codux AI 现在是基于 Rust 和 GPUI 构建的原生桌面应用，不再是 WebView 外壳。主界面、终端工作区、侧栏、弹窗、状态管理和自动更新链路都运行在原生进程中，让项目切换、终端渲染、Git 评审、文件浏览和 AI 活动追踪在长时间工作负载下保持更高响应性。
...
桌面端通过推送发布标签触发构建。发布工作流会构建 Rust 原生 macOS 和 Windows 产物，发布 GitHub Release，并更新对应的自动更新通道。
