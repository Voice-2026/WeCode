...
pub struct WeCodeApp {
    ...
    pub(in crate::app) gateway_model_catalog: wecode_runtime::gateway_service::GatewayModelCatalog,
    pub(in crate::app) gateway_models_refreshing: bool,
    pub(in crate::app) gateway_models_error: Option<String>,
    ...
    pub(in crate::app) wechat_bridge_watching: bool,
