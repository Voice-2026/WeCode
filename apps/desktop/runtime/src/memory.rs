...
pub fn memory_settings(settings: &AIMemorySettings) -> MemorySettings {
    MemorySettings {
        ...
        extraction_heuristic_gate_enabled: settings.extraction_heuristic_gate_enabled,
        extraction_growth_threshold_lines: settings.extraction_growth_threshold_lines,
        recall_use_fts: settings.recall_use_fts,
        privacy_scrub_enabled: settings.privacy_scrub_enabled,
