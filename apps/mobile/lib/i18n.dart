...
const Map<String, String> _zhCN = {
  ...
  'pair.codeHint': '6 位配对码',
  'pair.manualHelp': '选择电脑端使用的服务器，输入电脑端显示的 6 位配对码。',
  'pair.submit': '配对',
  ...
  'remote.pairingCodeInvalid': '请输入 6 位配对码',
...
const Map<String, String> _zhTW = {
  ...
  'pair.serverCustomHint': 'https://your-relay.example',
  'pair.codeHint': '6 位配對碼',
  'pair.manualHelp': '選擇電腦端使用的伺服器，輸入電腦端顯示的 6 位配對碼。',
  'pair.submit': '配對',
...
const Map<String, String> _en = {
  ...
  'pair.serverCustomHint': 'https://your-relay.example',
  'pair.codeHint': '6-digit code',
  'pair.manualHelp':
      'Choose the same server as desktop, then enter the 6-digit code shown there.',
  'pair.submit': 'Pair',
  'pair.networkHint':
  ...
  'remote.pairingCodeInvalid': 'Enter the 6-digit pairing code',
