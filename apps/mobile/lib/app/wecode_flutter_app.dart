...
class WeCodeFlutterApp extends StatefulWidget {
  const WeCodeFlutterApp({
    super.key,
    this.initialDevices,
  ...
  @override
  State<WeCodeFlutterApp> createState() => _WeCodeFlutterAppState();
}

class _WeCodeFlutterAppState extends State<WeCodeFlutterApp>
  ...
  Widget build(BuildContext context) {
    ...
    WeCodeTheme.brightness = brightness;
    return MaterialApp(
