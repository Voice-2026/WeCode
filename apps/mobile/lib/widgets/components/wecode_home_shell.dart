...
class WeCodeHomeShell extends StatelessWidget {
  const WeCodeHomeShell({
    super.key,
  ...
  final WeCodeHomeShellMetrics metrics;
  final WeCodeHomeShellPages pages;
  final WeCodeHomeShellState state;
  final WeCodeHomeOverlayState overlays;
  final WeCodeHomeShellActions actions;
...
class WeCodeHomeShellMetrics {
  const WeCodeHomeShellMetrics({
...
class WeCodeHomeShellPages {
  const WeCodeHomeShellPages({
...
class WeCodeHomeShellState {
  const WeCodeHomeShellState({
...
class WeCodeHomeOverlayState {
  const WeCodeHomeOverlayState({
...
class WeCodeHomeShellActions {
  const WeCodeHomeShellActions({
