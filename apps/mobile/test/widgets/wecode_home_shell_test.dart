...
import 'package:wecode_flutter/widgets/components/wecode_home_shell.dart';
    ...
    await tester.pumpWidget(
      _wrap(
        _shell(
          ...
          state: const WeCodeHomeShellState(
            showSettings: true,
            showTerminal: false,
...
WeCodeHomeShell _shell({
  required AnimationController controller,
  WeCodeHomeShellState state = const WeCodeHomeShellState(
    showSettings: false,
    showTerminal: false,
    showTerminalSwitcher: false,
  ),
  WeCodeHomeOverlayState? overlays,
}) {
  return WeCodeHomeShell(
    ...
    pages: const WeCodeHomeShellPages(
...
WeCodeHomeOverlayState _overlayState({String? toastMessage}) {
  return WeCodeHomeOverlayState(
    showScanner: false,
    pendingPairing: null,
