...
use self::{
    ...
    app_state::{
        ...
        TerminalCloseTarget, UpdateDialogPhase, WorktreeScopeKey, WorktreeSidebarLoad,
        WorktreeSwitchLoad, app_git_review, app_now_seconds, current_worktree_scope_key,
        git_status_tree_key, resize_git_credentials_window, resize_pet_custom_install_window,
        resize_pet_custom_install_window_handle, settings_with_active_restart_locked_values,
        worktree_summary_has_git_counts, worktree_summary_has_rows,
    },
    desktop_pet::*,
