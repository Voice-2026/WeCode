...
use wecode_ai_history::normalized::{AIHeatmapDay, AITimeBucket, AIUsageBreakdownItem};
use wecode_protocol::RemoteAIUsageAmount;
...
impl AIHistoryCurrentSessionView {
    pub fn from_remote(
        session: wecode_protocol::RemoteAICurrentSession,
        include_cached: bool,
    ) -> Self {
        Self {
...
pub fn ai_current_session_views(
    sessions: impl IntoIterator<Item = wecode_protocol::RemoteAICurrentSession>,
    include_cached: bool,
