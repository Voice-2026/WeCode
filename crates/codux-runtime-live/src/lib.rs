...
//! feeds the supervisor (`terminal_pty`), and the runtime path helpers they need
//! (`runtime_paths`). Kept free of AppKit/objc so a headless host can depend on
//! it without dragging in the desktop's platform layer.
