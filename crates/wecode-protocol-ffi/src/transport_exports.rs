...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_transport_relay_url(base: *const c_char) -> *mut c_char {
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_transport_relay_url_for_preset(
    preset: *const c_char,
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_transport_relay_presets_json() -> *mut c_char {
    string_to_c(remote_relay_presets_json())
}

/// Validate a DECODED pairing-payload JSON object (the caller does the stable
/// base64url/URL decode) through the SINGLE shared parser in `wecode_protocol`,
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_parse_pairing_payload(payload_json: *const c_char) -> *mut c_char {
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_transport_preferred_kind(
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_controller_transport_config_summary_json(
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_controller_transport_connect_json(
    config_json: *const c_char,
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_controller_transport_send_json(
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_controller_transport_send_terminal_json(
    transport: *mut FfiControllerTransport,
    envelope_json: *const c_char,
) -> bool {
    catch_unwind(AssertUnwindSafe(|| {
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_controller_transport_send_terminal_upload(
    transport: *mut FfiControllerTransport,
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_controller_transport_poll_event_json(
    transport: *mut FfiControllerTransport,
) -> *mut c_char {
    catch_unwind(AssertUnwindSafe(|| {
        let Some(transport) = controller_transport_ref(transport) else {
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_controller_transport_close(transport: *mut FfiControllerTransport) {
