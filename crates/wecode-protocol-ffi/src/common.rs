...
use wecode_terminal_core::{RemoteRuntimeModel, RemoteSequenceGuard};
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_protocol_last_error() -> *mut c_char {
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_protocol_string_free(value: *mut c_char) {
    if value.is_null() {
        return;
    }
    unsafe {
