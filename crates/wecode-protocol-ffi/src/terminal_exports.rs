...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_terminal_text_input_json(text: *const c_char) -> *mut c_char {
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_terminal_insert_input_json(text: *const c_char) -> *mut c_char {
    let Some(text) = c_to_string(text) else {
        return ptr::null_mut();
    };
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_terminal_key_input_json(
    key: *const c_char,
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_terminal_mouse_input_json(
    action: *const c_char,
    button: *const c_char,
    row: i64,
    col: i64,
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_remote_sequence_guard_new(
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_remote_sequence_guard_free(guard: *mut RemoteSequenceGuard) {
    if guard.is_null() {
        return;
    }
    unsafe {
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_remote_sequence_guard_accept(
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_remote_sequence_guard_reset(guard: *mut RemoteSequenceGuard) {
