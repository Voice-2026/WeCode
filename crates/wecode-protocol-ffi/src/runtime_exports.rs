...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_remote_runtime_model_new() -> *mut FfiRemoteRuntimeModel {
    Box::into_raw(Box::new(FfiRemoteRuntimeModel::new()))
}

#[unsafe(no_mangle)]
pub extern "C" fn wecode_remote_runtime_model_free(model: *mut FfiRemoteRuntimeModel) {
    if model.is_null() {
        return;
    }
    unsafe {
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_remote_runtime_model_snapshot_json(
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_remote_runtime_model_reset(
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_remote_runtime_model_restore_cached_projects_json(
    model: *mut FfiRemoteRuntimeModel,
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_remote_runtime_model_apply_project_list_json(
    model: *mut FfiRemoteRuntimeModel,
    projects_json: *const c_char,
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_remote_runtime_model_apply_terminal_list_json(
    model: *mut FfiRemoteRuntimeModel,
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_remote_runtime_model_user_select_project_json(
    model: *mut FfiRemoteRuntimeModel,
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_remote_runtime_model_project_selected_json(
    model: *mut FfiRemoteRuntimeModel,
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_remote_runtime_model_worktree_selected_json(
    model: *mut FfiRemoteRuntimeModel,
    project_id: *const c_char,
    worktree_id: *const c_char,
    terminal_visible: bool,
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_remote_runtime_model_apply_worktree_state_json(
    model: *mut FfiRemoteRuntimeModel,
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_remote_runtime_model_ensure_terminal_json(
    model: *mut FfiRemoteRuntimeModel,
    terminal_visible: bool,
    terminal_list_loaded: bool,
) -> *mut c_char {
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_remote_runtime_model_select_terminal_json(
    model: *mut FfiRemoteRuntimeModel,
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_remote_runtime_model_remove_terminal_json(
    model: *mut FfiRemoteRuntimeModel,
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_remote_runtime_model_apply_git_status_json(
    model: *mut FfiRemoteRuntimeModel,
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_remote_runtime_model_begin_terminal_create_json(
    model: *mut FfiRemoteRuntimeModel,
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_remote_runtime_model_terminal_created_json(
    model: *mut FfiRemoteRuntimeModel,
    terminal_json: *const c_char,
) -> *mut c_char {
    let Some(model) = remote_runtime_model_mut(model) else {
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_remote_runtime_model_mark_project_select_sent(
    model: *mut FfiRemoteRuntimeModel,
    project_id: *const c_char,
) {
    let Some(model) = remote_runtime_model_mut(model) else {
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_remote_runtime_model_clear_project_select_sent(
    model: *mut FfiRemoteRuntimeModel,
    project_id: *const c_char,
) {
    let Some(model) = remote_runtime_model_mut(model) else {
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_remote_runtime_model_pending_project_select(
    model: *const FfiRemoteRuntimeModel,
    include_sent: bool,
) -> *mut c_char {
    let Some(model) = remote_runtime_model_ref(model) else {
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_remote_runtime_model_current_project_terminals_json(
    model: *const FfiRemoteRuntimeModel,
) -> *mut c_char {
    let Some(model) = remote_runtime_model_ref(model) else {
        return ptr::null_mut();
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_remote_runtime_model_terminal_scope_for_project_json(
    model: *const FfiRemoteRuntimeModel,
    project_id: *const c_char,
) -> *mut c_char {
    let Some(model) = remote_runtime_model_ref(model) else {
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_remote_runtime_model_terminal_scope_for_session_json(
    model: *const FfiRemoteRuntimeModel,
