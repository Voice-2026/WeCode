...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_protocol_version() -> *mut c_char {
    string_to_c(REMOTE_PROTOCOL_VERSION)
}

#[unsafe(no_mangle)]
pub extern "C" fn wecode_protocol_message_type(name: *const c_char) -> *mut c_char {
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_protocol_resource_type(name: *const c_char) -> *mut c_char {
    let Some(name) = c_to_string(name) else {
        return ptr::null_mut();
    };
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_protocol_transport_kind(name: *const c_char) -> *mut c_char {
    let Some(name) = c_to_string(name) else {
        return ptr::null_mut();
    };
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_protocol_relay_blocks_message(kind: *const c_char) -> bool {
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_protocol_is_terminal_stream_message(kind: *const c_char) -> bool {
    let Some(kind) = c_to_string(kind) else {
        return false;
    };
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_protocol_resource_subscribe_json(
...
#[unsafe(no_mangle)]
pub extern "C" fn wecode_protocol_resource_unsubscribe_json(
    resource: *const c_char,
    project_id: *const c_char,
    session_id: *const c_char,
) -> *mut c_char {
