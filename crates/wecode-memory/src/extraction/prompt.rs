...
pub fn memory_extraction_json_schema() -> Value {
    json!({
        "type": "object",
        "properties": {
            "user_summary": {
            ...
            "working_add": {
                ...
                "items": {
                    ...
                    "properties": {
                        ...
                        "kind": {
                            "type": "string",
                            "enum": ["preference", "decision", "fact", "bug_lesson"]
                        },
                        "scope": {
                            "type": "string",
                            "enum": ["user", "project"]
