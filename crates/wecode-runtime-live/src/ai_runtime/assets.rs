...
const RUNTIME_ASSETS: &[(&str, &[u8])] = &[
    ...
    (
        ...
        include_bytes!("../../../../apps/desktop/runtime-assets/scripts/wrappers/bin/wecode-ssh"),
    ),
    (
        "scripts/wrappers/bin/wecode-ssh.ps1",
        include_bytes!(
            "../../../../apps/desktop/runtime-assets/scripts/wrappers/bin/wecode-ssh.ps1"
        ),
    ),
    (
        "scripts/wrappers/bin/wecode-db",
        include_bytes!("../../../../apps/desktop/runtime-assets/scripts/wrappers/bin/wecode-db"),
    ),
    (
        "scripts/wrappers/bin/wecode-db.ps1",
        include_bytes!(
            "../../../../apps/desktop/runtime-assets/scripts/wrappers/bin/wecode-db.ps1"
        ),
    ),
    (
    ...
    (
        "scripts/wrappers/wecode-ssh-expect.exp",
        include_bytes!(
            "../../../../apps/desktop/runtime-assets/scripts/wrappers/wecode-ssh-expect.exp"
        ),
    ),
    (
        "scripts/wrappers/wecode-ssh.ps1",
        include_bytes!("../../../../apps/desktop/runtime-assets/scripts/wrappers/wecode-ssh.ps1"),
    ),
    (
        "scripts/wrappers/wecode-db.ps1",
        include_bytes!("../../../../apps/desktop/runtime-assets/scripts/wrappers/wecode-db.ps1"),
    ),
    (
...
mod tests {
    ...
    fn stages_runtime_asset_and_nested_directory() {
        let dir = std::env::temp_dir().join(format!("wecode-runtime-assets-{}", Uuid::new_v4()));
