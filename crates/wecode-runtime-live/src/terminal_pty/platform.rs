...
pub(super) fn capture_shell_environment_uncached(
    ...
    let begin_marker = "__WECODE_SHELL_ENV_BEGIN__";
    let end_marker = "__WECODE_SHELL_ENV_END__";
...
pub(super) fn resolve_login_shell_path_uncached(
    ...
    let begin_marker = "__WECODE_LOGIN_PATH_BEGIN__";
    let end_marker = "__WECODE_LOGIN_PATH_END__";
