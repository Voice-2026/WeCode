...
pub fn terminal_environment(
        ...
        .or_else(|| context.map(|context| &context.support_dir))
    {
        ...
        values.insert(
            "WECODE_SSH_PROFILES_FILE".to_string(),
            support_dir.join("ssh_profiles.json").display().to_string(),
        );
        values.insert(
            "WECODE_DB_PROFILES_FILE".to_string(),
    ...
    values.insert("WECODE_DB_PROJECT_ID".to_string(), root_project_id);
    ...
    values.insert("WECODE_GPUI".to_string(), "1".to_string());
    ...
    values.insert("WECODE_PROJECT_ID".to_string(), project_id);
    values.insert("WECODE_PROJECT_NAME".to_string(), project_name);
    values.insert("WECODE_PROJECT_PATH".to_string(), project_path);
    values.insert("WECODE_TERMINAL_ID".to_string(), terminal_id.clone());
    values.insert("WECODE_SLOT_ID".to_string(), slot_id.clone());
